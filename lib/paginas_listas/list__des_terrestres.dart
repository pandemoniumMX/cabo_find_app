...
void main() {
  runApp(new MaterialApp(
    home: new ListaTerrestres(),

  ));
}

class ListaTerrestres extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();

}

class _ListaAcuaticas extends State<ListaTerrestres> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/descubre/list_descubre_terrestres.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/descubre/list_descubre_terrestres_baja.php"),
