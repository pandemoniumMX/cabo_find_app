...
class ListaCafe extends StatefulWidget {
  @override
  _ListaCafe createState() => new _ListaCafe();

}

class _ListaCafe extends State<ListaCafe> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_otros.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_otros_baja.php"),
