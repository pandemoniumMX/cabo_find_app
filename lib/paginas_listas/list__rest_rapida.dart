...
void main() {
  runApp(new MaterialApp(
    home: new ListaRapida(),

  ));
}

class ListaRapida extends StatefulWidget {
  @override
  _ListaMariscos createState() => new _ListaMariscos();

}

class _ListaMariscos extends State<ListaRapida> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_rapida.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_rapida_baja.php"),
