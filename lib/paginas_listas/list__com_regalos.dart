...
void main() {
  runApp(new MaterialApp(
    home: new ListaRegalos(),

  ));
}

class ListaRegalos extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();

}

class _ListaAcuaticas extends State<ListaRegalos> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/compras/list_compras_regalos.php"),
