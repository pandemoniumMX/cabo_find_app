...
void main() {
  runApp(new MaterialApp(
    home: new ListaInfantil(),

  ));
}

class ListaInfantil extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();

}

class _ListaAcuaticas extends State<ListaInfantil> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/educacion/list_educacion_infantil.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/educacion/list_educacion_infantil_baja.php"),
