...
class Publicaciones_restaurantes extends StatefulWidget {
...
class Publicacionesfull extends State<Publicaciones_restaurantes> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/list_publicaciones_restaurantes.php"),
