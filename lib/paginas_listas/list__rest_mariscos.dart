...
void main() {
  runApp(new MaterialApp(
    home: new ListaMariscos(),

  ));
}

class ListaMariscos extends StatefulWidget {
  @override
  _ListaMariscos createState() => new _ListaMariscos();

}

class _ListaMariscos extends State<ListaMariscos> {
...
List databaja;
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_restaurantes_mariscos_baja.php"),
