...
void main() {
  runApp(new MaterialApp(
    home: new Lista_anun_inmueble(),
  ));
}

class Lista_anun_inmueble extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();
}

class _ListaAcuaticas extends State<Lista_anun_inmueble> {
  List data;
  List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/anuncios/list_anuncios_inmuebles.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/anuncios/list_anuncios_inmuebles_baja.php"),
        headers: {"Accept": "application/json"});
          ...
          onTap: () {
            ...
            Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (context) => new Anuncios_detalle(
