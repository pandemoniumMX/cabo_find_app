...
void main() {
  runApp(new MaterialApp(
    home: new ListaItalianos(),

  ));
}

class ListaItalianos extends StatefulWidget {
  @override
  _ListaItalianos createState() => new _ListaItalianos();

}

class _ListaItalianos extends State<ListaItalianos> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_italianos.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_italianos_baja.php"),
