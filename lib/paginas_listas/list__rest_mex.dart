...
void main() {
  runApp(new MaterialApp(
    home: new ListaMexicanos(),

  ));
}

class ListaMexicanos extends StatefulWidget {
  @override
  _ListaMexicanos createState() => new _ListaMexicanos();

}

class _ListaMexicanos extends State<ListaMexicanos> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_mexicanos.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_mexicanos_baja.php"),
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return new ListTile(
            ...
            onTap: () {
              ...
              String cat_sql = databaja[index]["CAT_NOMBRE"];
              String subcat_sql = databaja[index]["SUB_NOMBRE"];
              String foto_sql = databaja[index]["GAL_FOTO"];
              String etiquetas_sql = databaja[index]["NEG_ETIQUETAS"];
              String desc_sql = databaja[index]["NEG_DESCRIPCION"];
              ...
              String hor = databaja[index]["NEG_HORARIO"];
