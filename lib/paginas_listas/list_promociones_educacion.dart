...
class Promociones_educacion extends StatefulWidget {
...
class Publicacionesfull extends State<Promociones_educacion> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/list_promociones_educacion.php"),
