...
void main() {
  runApp(new MaterialApp(
    home: new ListaOriental(),

  ));
}

class ListaOriental extends StatefulWidget {
  @override
  _ListaOriental createState() => new _ListaOriental();

}

class _ListaOriental extends State<ListaOriental> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_orientales.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/restaurantes/list_resturantes_orientales_baja.php"),
