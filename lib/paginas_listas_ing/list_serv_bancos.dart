...
void main() {
  runApp(new MaterialApp(
    home: new ListaBancos_ing(),

  ));
}

class ListaBancos_ing extends StatefulWidget {
  @override
  _ListaOriental createState() => new _ListaOriental();

}

class _ListaOriental extends State<ListaBancos_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_bancos.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_bancos_baja.php"),
