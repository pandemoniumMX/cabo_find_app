...
void main() {
  runApp(new MaterialApp(
    home: new ListaCafe_ing(),

  ));
}

class ListaCafe_ing extends StatefulWidget {
  @override
  _ListaCafe createState() => new _ListaCafe();

}

class _ListaCafe extends State<ListaCafe_ing> {
...
List databaja;
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_otros_baja.php"),
