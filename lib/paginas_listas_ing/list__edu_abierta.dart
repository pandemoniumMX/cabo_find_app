...
void main() {
  runApp(new MaterialApp(
    home: new ListaAbierta_ing(),

  ));
}

class ListaAbierta_ing extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();

}

class _ListaAcuaticas extends State<ListaAbierta_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/educacion/list_educacion_abierta.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/educacion/list_educacion_abierta_baja.php"),
