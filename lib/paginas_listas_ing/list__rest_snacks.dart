...
void main() {
  runApp(new MaterialApp(
    home: new ListaSnacks_ing(),

  ));
}

class ListaSnacks_ing extends StatefulWidget {
  @override
  _ListaSnacks createState() => new _ListaSnacks ();

}

class _ListaSnacks extends State<ListaSnacks_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_snacks.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_snacks_baja.php"),
