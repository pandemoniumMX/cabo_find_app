...
class Promociones_restaurantes_ing extends StatefulWidget {
...
class Publicacionesfull extends State<Promociones_restaurantes_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/list_promociones_restaurantes.php"),
