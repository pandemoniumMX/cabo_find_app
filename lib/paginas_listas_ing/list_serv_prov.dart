...
void main() {
  runApp(new MaterialApp(
    home: new ListaProveedores_ing(),

  ));
}

class ListaProveedores_ing extends StatefulWidget {
  @override
  _ListaOriental createState() => new _ListaOriental();

}

class _ListaOriental extends State<ListaProveedores_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_proveedores.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_proveedores_baja.php"),
