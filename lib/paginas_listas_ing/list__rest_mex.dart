...
void main() {
  runApp(new MaterialApp(
    home: new ListaMexicanos_ing(),

  ));
}

class ListaMexicanos_ing extends StatefulWidget {
  @override
  _ListaMexicanos_ing createState() => new _ListaMexicanos_ing();

}

class _ListaMexicanos_ing extends State<ListaMexicanos_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_mexicanos.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_mexicanos_baja.php"),
