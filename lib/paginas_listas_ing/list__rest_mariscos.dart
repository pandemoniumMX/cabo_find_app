...
void main() {
  runApp(new MaterialApp(
    home: new ListaMariscos_ing(),

  ));
}

class ListaMariscos_ing extends StatefulWidget {
  @override
  _ListaMariscos createState() => new _ListaMariscos();

}

class _ListaMariscos extends State<ListaMariscos_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_mariscos.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/restaurantes/list_resturantes_mariscos_baja.php"),
