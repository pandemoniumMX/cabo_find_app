...
void main() {
  runApp(new MaterialApp(
    home: new ListaModa_ing(),

  ));
}

class ListaModa_ing extends StatefulWidget {
  @override
  _ListaAcuaticas createState() => new _ListaAcuaticas();

}

class _ListaAcuaticas extends State<ListaModa_ing> {
...
List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/compras/list_compras_moda.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/compras/list_compras_moda_baja.php"),
