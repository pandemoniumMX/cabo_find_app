...
void main() {
  runApp(new MaterialApp(
    home: new ListaTransporte_ing(),
  ));
}

class ListaTransporte_ing extends StatefulWidget {
  @override
  _ListaOriental createState() => new _ListaOriental();
}

class _ListaOriental extends State<ListaTransporte_ing> {
  List data;
  List databaja;
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_transporte.php"),
  ...
  Future<String> getDatabaja() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/servicios/list_servicios_transporte_baja.php"),
        headers: {"Accept": "application/json"});

    this.setState(() {
      databaja = json.decode(response.body);
    });
    print(databaja[0]["NEG_NOMBRE"]);
            ...
            child: new Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(children: <Widget>[
                    Padding(
                        child: Text(data[index]["SUB_NOMBRE_ING"]),
            ...
            child: new Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(children: <Widget>[
                    Padding(
                        child: Text(databaja[index]["SUB_NOMBRE_ING"]),
                        padding: EdgeInsets.all(1.0)),
                    Text(" | "),
                    Padding(
                        child: new Text(databaja[index]["NEG_NOMBRE"]),
                        padding: EdgeInsets.all(1.0)),
                    Text(" | "),
                    Flexible(
                      child: new Text(
