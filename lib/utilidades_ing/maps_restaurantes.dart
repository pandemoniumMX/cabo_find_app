...
class Maps_restaurantes_ing extends StatefulWidget {
  Maps_restaurantes_ing({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_restaurantes_ing> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/ing/mapas/restaurantes.php');
  ...
  Future<String> getCar() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/mapas/restaurantes.php"),
              ...
              child: Column(
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/mariachi.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/pizza.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/ramen.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25, 
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/lobster.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/burger.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/spoon.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25, 
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/sugar.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25, 
                        // placeholder: AssetImage('android/assets/images/jar-loading.gif'),  
