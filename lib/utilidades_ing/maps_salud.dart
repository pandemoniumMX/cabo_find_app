...
class Maps_salud_ing extends StatefulWidget {
  Maps_salud_ing({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_salud_ing> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/ing/mapas/salud.php');
