...
class Empresa_detalle_pub extends StatefulWidget {

@override
_Empresa_detalle_pub createState() => new _Empresa_detalle_pub();


}
List data;

class _Empresa_detalle_pub extends State<Empresa_detalle_pub> {
