...
Widget build(BuildContext context) {
  ...
  final bnbi=<BottomNavigationBarItem>[
    BottomNavigationBarItem(icon: Icon(Icons.star,),title: Text("Hospitals")),
    BottomNavigationBarItem(icon: Icon(Icons.favorite,),title: Text("Surgeries")),
    BottomNavigationBarItem(icon: Icon(Icons.fiber_new,),title: Text("Specialties")),
    BottomNavigationBarItem(icon: Icon(Icons.visibility,),title: Text("Pharmacy")),
    BottomNavigationBarItem(icon: Icon(Icons.favorite,),title: Text("Emergency services")),
