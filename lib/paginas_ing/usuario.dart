...
class Usuario_ing extends StatefulWidget {
  ...
  Usuario_ing({Key key, @required this.usuarios}) : super(
    key: key);
  @override
                      ...
                      children: <Widget>[
                        Center(child: Column(
                          ...
                          children: <Widget>[
                              ...
                              children: <Widget>[
                                Text("Profile",style: TextStyle(fontSize:40, color: Colors.white,fontWeight: FontWeight.bold ),),]),
                              ...
                              children: <Widget>[
                                Text("Settings",style: TextStyle(fontSize:40, color: Colors.white,fontWeight: FontWeight.bold ),),]),

                                Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                              Text("Push notifications:",style: TextStyle(fontSize:25, color: Colors.white ),),
                              Switch(
                                value: isSwitched,
                                onChanged: (value) {
                                  setState(() {
                              ...
                              Center(
                                ...
                                child: new Row (
                                          ...
                                          children: <Widget>[
                                            new Text('Sign out', style: TextStyle(fontSize: 20, color: Colors.white)), 
