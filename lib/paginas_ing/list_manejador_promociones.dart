...
class Manejador_promociones_ing extends StatefulWidget {
  ...
  Manejador_promociones_ing({Key key, @required this.cat}) : super(key: key);
...
Future<String> getData() async {
    ...
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/ing/list_promociones_manejador.php?CAT=${widget.cat.cat}&CITY=$_city"),
  ...
  Future<String> insertRecomendacion(id_c) async {
    ...
    if (_status == "True") {
      ...
      var response = await http.get(
          Uri.encodeFull(
              "http://cabofind.com.mx/app_php/APIs/ing/insert_recomendacion_publicacion.php?MOD=${androidInfo.model}&BOOT=${androidInfo.display},${androidInfo.bootloader},${androidInfo.fingerprint}&VERSION=${androidInfo.product}&IDIOMA=${currentLocale}&ID=${id_c}&SO=Android&CORREO=${_mail}"),
          headers: {"Accept": "application/json"});
    } else {
