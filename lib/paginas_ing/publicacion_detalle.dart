...
class Publicacion_detalle_fin_ing extends StatefulWidget {
  ...
  Publicacion_detalle_fin_ing(
      {Key key, @required this.publicacion, this.empresa})
      : super(key: key);

  @override
  _Publicacion_detalle_fin_ing createState() =>
      new _Publicacion_detalle_fin_ing();
}
