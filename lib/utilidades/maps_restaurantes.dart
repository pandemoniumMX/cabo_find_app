...
class Maps_restaurantes extends StatefulWidget {
  Maps_restaurantes({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_restaurantes> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/restaurantes.php');
  ...
  Future<String> getCar() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/restaurantes.php"),
