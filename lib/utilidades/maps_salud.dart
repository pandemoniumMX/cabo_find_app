...
class Maps_salud extends StatefulWidget {
  Maps_salud({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_salud> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/salud.php');
