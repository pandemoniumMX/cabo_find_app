...
class Maps_servicios extends StatefulWidget {
  Maps_servicios({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_servicios> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/servicios.php');
  ...
  Future<String> getCar() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/servicios.php"),
