...
class Maps_compras extends StatefulWidget {
  Maps_compras({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Maps_compras> {
 ...
 Completer<GoogleMapController> _controller = Completer();
  ...
  getData() async {
    try {
      final response =
          await http.get('http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/compras.php');
  ...
  Future<String> getCar() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/consultas_negocios/esp/mapas/compras.php"),
              ...
              child: Column(
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/poloshirt.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/gift.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                        // placeholder: AssetImage('android/assets/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/diamond2.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25, 
                        // placeholder: AssetImage('android/assets/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/shop.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,
                        // placeholder: AssetImage('android/assets/jar-loading.gif'),  
                  ...
                  Row(
                    children: <Widget>[
                      FadeInImage(   
                        image: ExactAssetImage('assets/give.png'),
                        fit: BoxFit.cover,  
                        width: 25,                          
                        height: 25,  
                        // placeholder: AssetImage('android/assets/jar-loading.gif'),  
