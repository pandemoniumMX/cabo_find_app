        ...
        Container(
          ...
          child: Container(
            ...
            child: Column(children: [
              Text(data[index]["NEG_NOMBRE"],style: TextStyle(fontSize: 25,color: Colors.black),),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                new Icon(FontAwesomeIcons.locationArrow, color: Colors.black87,size: 12,),        
                Text('  ',style: TextStyle(fontSize: 12,color: Colors.black),),        
                Text(data[index]["NEG_LUGAR"],style: TextStyle(fontSize: 12,color: Colors.black87),),
              ],),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                Text('Vencimiento: ',style: TextStyle(fontSize:12,color: Colors.black),textAlign: TextAlign.center,),
                
                Text (dateFormat.format(DateTime.parse(data[index]["CUP_FECHA_CADUCIDAD"])),style: TextStyle(fontSize:12,color: Colors.orange),textAlign: TextAlign.center,)
                ]),
            ],),
          ),
          ),
