...
Hotel_detalle({Key key, @required this.empresa}) : super(
    key: key);
     ...
     children: [
       ...
       Column(
         children: <Widget>[
           ...
           Flexible(child: Text('Servicios propiedad', style: TextStyle(color: Colors.black),)),
         ],
       ),
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return <Widget>[
            SliverAppBar(
              ...
              floating: false,
              pinned: true,
              title: SABT(child: Text('testing',style: TextStyle(fontSize: 18),)),    
