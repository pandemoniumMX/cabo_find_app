...
class _DomicilioState extends State<Domicilio> {
  ...
  Future<String> getData() async {
    ...
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/APIs/esp/list_domicilio_rest.php?CITY=$_city"),
  ...
  Future<String> getNew() async {
    ...
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/APIs/esp/list_domicilio_rest_new.php?CITY=$_city"),
        headers: {"Accept": "application/json"});
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            new Text(' - ' + data[index]['CAT_NOMBRE'],
                                style: new TextStyle(
                                  color: Colors.black,
                                  fontSize: 12.0,
                                  fontWeight: FontWeight.w600,
                        ...
                        children: [
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(10.0),
                              child: FadeInImage(
                                image: NetworkImage(nuevos[index]['GAL_FOTO']),
                                fit: BoxFit.fill,
                                width: 300,
                                height: 150,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            new Text(' - ' + nuevos[index]['CAT_NOMBRE'],
                                style: new TextStyle(
                                  color: Colors.black,
                                  fontSize: 12.0,
                                  fontWeight: FontWeight.w600,
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                width: 300,
                                height: 150,
                                imageUrl: nuevos[index]["GAL_FOTO"],
                                progressIndicatorBuilder:
                                    (context, url, downloadProgress) =>
                                        CircularProgressIndicator(
                                            value: downloadProgress.progress),
                  ...
                  : new InkWell(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 10.0),
                            child: new Text(nuevos[index]['NEG_NOMBRE'],
                                style: new TextStyle(
                                  color: Colors.black,
                                  fontSize: 12.0,
                                  fontWeight: FontWeight.w900,
