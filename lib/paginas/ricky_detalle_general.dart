...
class Myapp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        home: new Container(child: new Ricky_general()));
  }
}
...
class Ricky_general extends StatefulWidget {
  ...
  @override
  Ricky_general({Key key, @required this.empresa}) : super(key: key);
      ...
      return showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            ...
            content: Text(
                "En caso de dañar el equipo de playa, se deberá cubrir el 50% " +
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) => new Rick_preparing(
                              costos: new Costos(paquete, costo))));
                },
              )
            ],
          );
                  ...
                  return showDialog(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content: FadeInImage(
                            image: NetworkImage(
                                "http://cabofind.com.mx/assets/galeria/cobertura.png"),
                            fit: BoxFit.fill,
                            width: MediaQuery.of(context).size.width,
                    ...
                    Column(
                      children: <Widget>[
                        FloatingActionButton(
                          ...
                          onPressed: () => FlutterYoutube.playYoutubeVideoByUrl(
