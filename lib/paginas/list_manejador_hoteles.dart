...
class Lista_Manejador_hotel extends StatefulWidget {

  final Lista_manejador manejador;

  Lista_Manejador_hotel({Key key, @required this.manejador}) : super(
    key: key);
...
class _ListaAcuaticas extends State<Lista_Manejador_hotel> {
