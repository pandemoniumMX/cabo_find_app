...
class Lista_Manejador_hoteles extends StatefulWidget {
  ...
  Lista_Manejador_hoteles({Key key, @required this.manejador}) : super(
    key: key);
              ...
              child: Row(
                ...
                children: [
                  ...
                  child: new Row (
                    ...
                    children: <Widget>[
                      new Icon(FontAwesomeIcons.slidersH, color: Colors.white,),
                      new Text('  FILTRAR', style: TextStyle(fontSize: 20, color: Colors.white)), 
                ...
                RaisedButton(
                  ...
                  child: new Row (
                    ...
                    children: <Widget>[
                      new Icon(FontAwesomeIcons.map, color: Colors.white,),
                      new Text('  MAPA', style: TextStyle(fontSize: 20, color: Colors.white)), 
