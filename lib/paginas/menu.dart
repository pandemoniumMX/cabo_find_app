...
class Menu_comidas extends StatefulWidget {
  ...
  Menu_comidas( {Key key, @required this.manejador}) : super(
    key: key);  
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      actions: <Widget>[
                ...
                child: Stack(
                    ...
                    new Center(
                      child: new Row(                   
                        children: <Widget>[new Icon(FontAwesomeIcons.shoppingCart),
                        Text("  ",                    
    ...
    BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.dog,),title: Text("Pets")),
      ...
      body: new PageView(
        ...
        children: <Widget>[
          new Menu_manejador(manejador: new Users('37')),//idnegocio
          Boton_sig()
    ...
    return Stack(
      children: <Widget>[
                          Positioned(
                            ...
                            children: <Widget>[
                              new Icon(FontAwesomeIcons.arrowAltCircleRight, color: Colors.black,),
                              new Text(' Siguiente', style: TextStyle(fontSize: 15, color: Colors.black)), 
                          ...
                          Positioned(
                            ...
                            children: <Widget>[
                              new Icon(FontAwesomeIcons.arrowAltCircleRight, color: Colors.white,),
                              new Text(' Siguiente', style: TextStyle(fontSize: 15, color: Colors.white)), 
