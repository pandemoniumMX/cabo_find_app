...
final Reserva reserva;
 ...
 Reservacion({Key key, @required this.reserva}) : super(
    key: key);
@override
...
class Detalles extends State<Reservacion> {
  ...
  Future<String> insertRickys(nombre1,numero1,correo1, _mySelection) async {
    ...
    var response = await http.get(
        Uri.encodeFull(
           "http://cabofind.com.mx/app_php/APIs/esp/insert_reservacion.php?NOM=${nombre1}&NUM=${numero1}&NEGOCIO=${widget.reserva.nombre}&ID_NEGOCIO=${widget.reserva.id}&TIPO_R=${widget.reserva.tipo_r}&TIPO_N=${widget.reserva.tipo_n}&PERSONAS=${_mySelection}&CORREO=${correo1}&FECHA=${_date}&HORA=${_time}&PLATAFORMA=iOS&IDIOMA=ESP"),
    ...
    return new Scaffold(
      ...
      RaisedButton(
                  ...
                  child: new Row (
                    ...
                    children: <Widget>[
                      new Text('Reservar ahora ', style: TextStyle(fontSize: 20, color: Colors.white)), 
