...
class Lista_pedidosx extends StatefulWidget {
  final Costos carrito;
  Lista_pedidosx({Key key, @required this.carrito}) : super(key: key);
  @override
  _Pedidos_nuevosState createState() => _Pedidos_nuevosState();
}

class _Pedidos_nuevosState extends State<Lista_pedidosx> {
  List data;
  List ext;
  List carrito;
  ...
  Future<String> _cargarPedido() async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/APIs/esp/pedidos_nuevos_detalle.php?IDN=${widget.carrito.costo}&IDC=${widget.carrito.paquete}"),
        ...
        Navigator.pushReplacement(
            ...
            new MaterialPageRoute(
                builder: (BuildContext context) => new Domicilio(
                    numeropagina: Categoria(2), numtab: Categoria(0))));
      },
      child: Scaffold(
        appBar: AppBar(
          title: Text('Regresar'),
