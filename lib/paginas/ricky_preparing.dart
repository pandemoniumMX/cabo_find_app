...
class Detalles extends State<Rick_preparing> {
  ...
  Future<String> sendMail(total,cts1, nombre1, numero1, _mySelection, pago) async {
    var response = await http.get(
        Uri.encodeFull(
            "http://cabofind.com.mx/app_php/APIs/esp/insert_rickys.php?NOMBRE=${nombre1}&CELULAR=${numero1}&PLAYA=${_mySelection}&FECHA=${_date}&HORA=${_time}&PAQUETE=${widget.costos.paquete}&TOTAL=${total}&PAGO=${pago}&PLATAFORMA=iOS"),
