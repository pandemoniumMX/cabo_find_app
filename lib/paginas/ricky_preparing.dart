...
class Myapp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        home: new Container(child: new Rick_preparing()));
  }
}
...
//final Publicacion publicacion;
  ...
  @override
  Rick_preparing({Key key, @required this.costos}) : super(key: key);
  @override
...
class Detalles extends State<Rick_preparing> {
  ...
  Future<String> sendMail(
      total, cts1, nombre1, numero1, _mySelection, pago) async {
  ...
  Widget build(BuildContext context) {
    _urlMercado250() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-1244bd6c-253e-49e9-8368-a6a21345e996";
    ...
    _urlMercado350() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-8616adc5-5e58-4726-9be8-ef6727a837a7";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
    ...
    _urlMercado500() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-8a4d9d78-0129-40a6-908b-8c200624e45b";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
    ...
    _urlMercado600() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-c644126f-e4c8-405f-bbcf-97d053a6d3f5";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
    ...
    _urlMercado800() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-6b2ccb85-39e6-4f87-b53c-391e9fd5c468";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
    ...
    _urlMercado900() async {
      final url =
          "https://www.mercadopago.com.mx/checkout/v1/redirect?pref_id=528197060-5275ee98-8ca3-4250-a34b-2d62f88ca681";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
        ...
        return showDialog(
          ...
          builder: (BuildContext context) {
            ...
            return AlertDialog(
              ...
              content: new Text(
                  "Será dirigido a MercadoPago, una vez hecho el pago " +
              ...
              actions: <Widget>[
                ...
                new FlatButton(
                    ...
                    onPressed: () {
                      sendMail(
                          total, cts1, nombre1, numero1, _mySelection, pago);
                      showResena();
                      _urlMercado250();
                            ...
                            onPressed: () {
                              ...
                              if (_formKey.currentState.validate()) {
                                if (_mySelection == '1') {
                                  ...
                                  alertPaypal(context, cts1, nombre1, numero1,
                                      _mySelection);
                                } else if (_mySelection == '2') {
                                  print("santaalv");
                                  final String cts1 = '100';
...
/*
         Column(
           children: <Widget>[
             FloatingActionButton(child: Icon(FontAwesomeIcons.ccApplePay), onPressed:() => (context),backgroundColor:Colors.black,heroTag: "bt2",elevation: 0.0,),
                          ...
                          FloatingActionButton(
                            ...
                            onPressed: () {
                              ...
                              if (_formKey.currentState.validate()) {
                                if (_mySelection == '1') {
                                  final String cts1 = '100';
                                  alertMercado(context, cts1, nombre1, numero1,
                                      _mySelection);
                                } else if (_mySelection == '2') {
                                  print("santamercado");
                                  final String cts1 = '100';
                          ...
                          FloatingActionButton(
                            ...
                            onPressed: () {
                              ...
                              if (_formKey.currentState.validate()) {
                                if (_mySelection == '1') {
                                  final String cts1 = '100';
                                  alertCash(context, cts1, nombre1, numero1,
                                      _mySelection);
                                } else if (_mySelection == '2') {
                                  print("santacash");
                                  final String cts1 = '100';
